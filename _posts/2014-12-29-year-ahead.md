...
On December 19, 2013, a little over a year ago, I finished (Sketching with CSS)[www.sketchingwithcss.com], the first product I've ever made and sold for money. As I write this it's December 29, 2014 and I've made $52,553 in product sales.
...
I admire the ability of some entrepreneurs to build product after product and then repeatedly and predictably make small piles of money. This stuff is supposed to be hard. We're supposed to fail more often than not, but I have friends who can throw together a product in 24 hours and make thousands of dollars. (<-link to amy/nathan thing). Every time Nathan Barry or Brennan Dunn do a wrap up post after a launch, I picture them putting on old-timey bathing suits and diving into their earnings Scrooge McDuck style.

It's obviously not random chance or luck, because these folks do it over and over again. Yes, sometimes a product flops but it's the exception, not the rule, at least for people that know what they are doing.
...
I have a few $10,000 launches under my belt now and the biggest takeaway for me this year has been that with a little effort applied in the right sequence, I can make sales whenever I need them. I made far less money this year than I would have if I'd stayed at my regular day job, but learning how to create, market and sell a product consistently for a profit is worth much more than 1 year of a developer salary. Sooooooo much more. Also, this was the most fun I've had "working" in my entire life. Even if I don't eventually outpace my old developer salary, (unlikely), the fun and challenge totally makes up for it.
...
I can create products that people want and I know how to get attention and then convert that attention into sales. This is how I know I can hit my revenue goals this year. All I need to do is repeat what I did last year, plus a little more. The beauty of selling products vs. my time is I won't have to put in twice as much effort to make twice as much money. It's more like a snowball rolling down a hill, getting bigger and bigger with every revolution.
...
* My biggest resource is my email (newsletter)[http://www.planningforaliens.com/the-invasion/] for web designers/developers, which is just shy of 10,000 email addresses.
...
* [An awesome freebie](http://www.sketchingwithcss.com/flexbox-tutorial/) that I give away as a sweetner for signing up for my newsletter
...
For list building, my most effective tool has been content marketing. I write really, big, epic blog posts on topics I know my audience cares about, (because research), and ideally, closely related to one of my products. (The closer it is to my product, the more sales I make). These articles sometimes spread on their own, but most of the time I have to aggressively push them out to various link aggregating sites (e.g. reddit, hacker news), people on twitter with lots of followers, topically related email newsletters, etc. Guest posting is a great way to get writing in front of new people, and has worked well for me in the past. I need to do more of it.
...
* Giveaways have been a useful tool for list building this year. I create a prize package of products related to my product and then use the King Sumo plugin (<- king sumo url) to run the contest. (Interesting note: this is the only form of paid advertising I've had any success with.)
* I experimented with content that is easier for me to create, like "ranty" posts or writing on higher level topics, (basically, technical writing is the hardest IMO), cheat sheets and big linked lists (<- link to cheat sheets and ginormous list). These were hit or miss, but on average it has been a good approach.
...
All of this list building is usually done with the intention of launching a product to my list. I have two products, and I've launched both of them multiple times.  I've written one book and created a video course on Angular. Video is a little easier for me to do, but harder to update later, so a fast moving target like Angular is problematic. But overall video is still less time for me to put together and more valuable to some people, (depends on the person, not everyone likes video). If I do another product this year, (and I probably will), it will most likely be video.
...
I'll be writing more about my business in 2015. I have a few business posts from this year that I find myself referring back to for reference. So it makes sense that I should put my thoughts down while they are fresh. That also means you can check in on me and see if I hit my goal and how I did it.
