...
steps. Here's a quick start guide."
author: "sean"
---

Getting started with Grunt is a lot like the first time I installed Linux &mdash; I was nearly
buried alive under a pile of configuration options and files and
documentation.
...
{% highlight bash %}
grunt-init gruntfile (answer the questions, see screenshot){% endhighlight %}
...
(There's probably a way to share grunt configurations accross projects
...
when you rant grunt-init), and find the section toward the bottom with
...
Okay okay, it's only step 7 but it sure feels like more.
